...
public class TabSyllabus extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Animation myanim= AnimationUtils.loadAnimation(getActivity(),R.anim.listanimation);
        MyPDFListView.startAnimation(myanim);
